...
info_csv = pd.read_csv(os.path.join(processed_path, 'full_images.csv'))

images = h5py.File(os.path.join(processed_path,
                                "full_images.hdf5"), "r")['images']

f = h5py.File(os.path.join(processed_path, "full_images_illumcorr.hdf5"), "w")
