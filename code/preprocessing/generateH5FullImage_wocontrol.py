...
combined = combined[~((combined['Image_Metadata_Compound'] == 'taxol')
                      & (combined['Image_Metadata_Concentration'] == 0.3))]
...
f = h5py.File(os.path.join(proj_root, "input/processed/full_images_wocontrol.hdf5"), "w")
...
outCSV.to_csv(os.path.join(proj_root, 'input/processed/full_images_wocontrol.csv'))
pbar.close()
